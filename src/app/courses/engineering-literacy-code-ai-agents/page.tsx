...
export default async function LearnPage() {
  ...
  return (
    <main className="relative mx-auto min-h-dvh w-full max-w-5xl px-5 py-8 sm:px-8 sm:py-10">
      ...
      <div className="flex max-w-4xl items-start gap-3">
        ...
        <div>
          ...
          {releaseNote && (
            <p className="mt-2 inline-block rounded-full border border-line bg-surface px-3 py-1 text-xs font-medium text-muted">
              {releaseNote}
            </p>
          )}
        </div>
      ...
      {next && currentModule && (
        <section className="mt-6 rounded-lg border border-primary/30 bg-surface p-4 shadow-sm sm:p-5">
      ...
      {currentModule && (
        <section className="mt-6">
          ...
          <ol className="mt-4 divide-y divide-line overflow-hidden rounded-lg border border-line bg-surface shadow-sm">
              ...
              return (
                <li key={l.id}>
                  <Link
                    ...
                    className={`grid grid-cols-[2.25rem_minmax(0,1fr)_auto] items-center gap-4 px-4 py-4 text-base transition-colors hover:bg-background sm:px-5 ${
                      isNext ? "bg-primary/5" : ""
                    }`}
                  >
                    <span
      ...
      <details className="mt-6 rounded-lg border border-line bg-surface p-4 shadow-sm">
        <summary className="cursor-pointer text-sm font-medium text-muted">
          <span className="mr-2 text-primary">+</span>
          {t.courseArc}
        </summary>
        <ol className="mt-4 grid gap-3 border-t border-line pt-4 sm:grid-cols-2 lg:grid-cols-5">
